...
> Canonical full-text version of every prompt sent by `v11_run.py`. If this doc and the script disagree, the script wins — update both together.
>
> **v11 cold:** i_tone=cold, i_presence=absent. No interviewer presence markers. Checkpoints are directive ("Write out your framework"). Tribunal (P7–P10, F1) is cold in all registers. Gauntlet warmth inherits from bios.
>
> **Changes from v9b:** P2/P3 rewritten (honest moral scrutiny + model picks system). P6 moved from Orientation to Calibration (CKA now ends Orientation). Gauntlet rebalanced: 8 voices, i_VIC floor .4. Phase names: Orientation / Calibration / Grounding / Gauntlet / Synthesis.
...
*(Unchanged across all v11 registers.)*
