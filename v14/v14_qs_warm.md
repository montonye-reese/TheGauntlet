...
>
> **v11 warm:** i_tone=warm, i_presence=present. Checkpoints softened ("Pause here..."). Interviewer is acknowledged but not seated. Tribunal (P7–P10, F1) stays cold in all registers. Gauntlet warmth inherits from bios.
>
> **Changes from v9b:** P2/P3 rewritten (honest moral scrutiny + model picks system). P6 moved from Orientation to Calibration (CKA now ends Orientation). Gauntlet rebalanced: 8 voices, i_VIC floor .4. Phase names: Orientation / Calibration / Grounding / Gauntlet / Synthesis. Also revised advice for evaluating the gauntlet - remove 'they can be unreliable narrators'
